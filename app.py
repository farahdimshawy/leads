...
QUERIES = [
    ...
    {"q": 'site:facebook.com "forex" "Bulgaria"',         "assets": ["forex"],          "use_cases": [],                      "platforms": ["facebook"]},
    {"q": 'site:facebook.com "gold trading" "Bulgaria"',  "assets": ["gold"],           "use_cases": [],                      "platforms": ["facebook"]},
    {"q": 'site:facebook.com "stocks" "Bulgaria"',        "assets": ["stocks"],         "use_cases": [],                      "platforms": ["facebook"]},
    {"q": 'site:facebook.com "trading" "Bulgaria"',       "assets": [],                 "use_cases": [],                      "platforms": ["facebook"]},
    {"q": 'site:instagram.com "forex Bulgaria"',          "assets": ["forex"],          "use_cases": [],                      "platforms": ["instagram"]},
    {"q": 'site:instagram.com "gold trading Bulgaria"',   "assets": ["gold"],           "use_cases": [],                      "platforms": ["instagram"]},
    {"q": 'site:tiktok.com "forex Bulgaria"',             "assets": ["forex"],          "use_cases": [],                      "platforms": ["tiktok"]},
    {"q": 'site:tiktok.com "XAUUSD Bulgaria"',            "assets": ["gold"],           "use_cases": [],                      "platforms": ["tiktok"]},
    {"q": 'site:t.me "forex Bulgaria"',                   "assets": ["forex"],          "use_cases": [],                      "platforms": ["telegram"]},
    {"q": 'site:t.me "gold trading Bulgaria"',            "assets": ["gold"],           "use_cases": [],                      "platforms": ["telegram"]},
    # --- Bulgarian-language general ---
    {"q": 'site:facebook.com "форекс" "България"',        "assets": ["forex"],          "use_cases": [],                      "platforms": ["facebook"]},
    {"q": 'site:facebook.com "търговия" "форекс"',        "assets": ["forex"],          "use_cases": [],                      "platforms": ["facebook"]},
    {"q": 'site:facebook.com "злато" "търговия"',         "assets": ["gold"],           "use_cases": [],                      "platforms": ["facebook"]},
    {"q": 'site:facebook.com "акции" "инвестиции"',       "assets": ["stocks"],         "use_cases": [],                      "platforms": ["facebook"]},
    {"q": 'site:instagram.com "форекс" "България"',       "assets": ["forex"],          "use_cases": [],                      "platforms": ["instagram"]},
    {"q": 'site:tiktok.com "форекс" "България"',          "assets": ["forex"],          "use_cases": [],                      "platforms": ["tiktok"]},
    {"q": 'site:t.me "форекс" "България"',                "assets": ["forex"],          "use_cases": [],                      "platforms": ["telegram"]},
    # --- Signal providers ---
    {"q": 'site:t.me "сигнали" "форекс"',                 "assets": ["forex"],          "use_cases": ["signal_provider"],     "platforms": ["telegram"]},
    {"q": 'site:facebook.com "forex signals" "Bulgaria"', "assets": ["forex"],          "use_cases": ["signal_provider"],     "platforms": ["facebook"]},
    ...
    {"q": 'site:t.me "сигнали" "злато"',                  "assets": ["gold"],           "use_cases": ["signal_provider"],     "platforms": ["telegram"]},
    # --- Forex educators ---
    {"q": 'site:facebook.com "learn forex" "Bulgaria"',   "assets": ["forex"],          "use_cases": ["forex_educator"],      "platforms": ["facebook"]},
    {"q": 'site:facebook.com "forex course" "Bulgaria"',  "assets": ["forex"],          "use_cases": ["forex_educator"],      "platforms": ["facebook"]},
    ...
    {"q": 'site:facebook.com "обучение" "форекс"',        "assets": ["forex"],          "use_cases": ["forex_educator"],      "platforms": ["facebook"]},
    {"q": 'site:t.me "обучение" "търговия"',              "assets": [],                 "use_cases": ["forex_educator"],      "platforms": ["telegram"]},
    # --- Introducing brokers ---
    {"q": 'site:facebook.com "best forex broker" "Bulgaria"', "assets": ["forex"],      "use_cases": ["introducing_broker"],  "platforms": ["facebook"]},
    {"q": 'site:facebook.com "regulated broker" "Bulgaria"',  "assets": [],             "use_cases": ["introducing_broker"],  "platforms": ["facebook"]},
    {"q": 'site:t.me "forex broker Bulgaria"',            "assets": ["forex"],          "use_cases": ["introducing_broker"],  "platforms": ["telegram"]},
    {"q": 'site:t.me "low spread broker"',                "assets": [],                 "use_cases": ["introducing_broker"],  "platforms": ["telegram"]},
    {"q": 'site:tiktok.com "best broker forex"',          "assets": ["forex"],          "use_cases": ["introducing_broker"],  "platforms": ["tiktok"]},
    {"q": 'site:facebook.com "брокер" "форекс"',          "assets": ["forex"],          "use_cases": ["introducing_broker"],  "platforms": ["facebook"]},
    {"q": 'site:t.me "регулиран брокер"',                 "assets": [],                 "use_cases": ["introducing_broker"],  "platforms": ["telegram"]},
    # --- Mirror / copy trading ---
    {"q": 'site:facebook.com "copy trading" "Bulgaria"',  "assets": [],                 "use_cases": ["mirror_trading"],      "platforms": ["facebook"]},
    ...
    {"q": 'site:facebook.com "копиране на сделки"',       "assets": [],                 "use_cases": ["mirror_trading"],      "platforms": ["facebook"]},
    {"q": 'site:t.me "копиране на сделки"',               "assets": [],                 "use_cases": ["mirror_trading"],      "platforms": ["telegram"]},
    # --- Money managers ---
    ...
    {"q": 'site:tiktok.com "trade for me forex"',         "assets": ["forex"],          "use_cases": ["money_manager"],       "platforms": ["tiktok"]},
    {"q": 'site:facebook.com "управление на средства"',   "assets": [],                 "use_cases": ["money_manager"],       "platforms": ["facebook"]},
]
...
TELEGRAM_SEARCH_TERMS = [
    "forex Bulgaria", "gold trading Bulgaria", "stocks Bulgaria", "trading Bulgaria",
    "XAUUSD", "EURUSD", "NASDAQ trading", "TradingView", "MT4", "MT5",
    "forex signals", "gold signals", "XAUUSD signals", "telegram signals",
    "buy sell signal", "entry stop loss take profit",
    "learn forex", "forex course", "trading education", "technical analysis",
    "risk management", "beginner trader",
    "best forex broker", "regulated broker", "low spread broker", "broker Bulgaria",
    "deposit withdrawal broker",
    "copy trading", "mirror trading", "PAMM", "MAM account", "managed account",
    "trade for me",
    "форекс", "търговия", "злато", "акции", "инвестиции", "сигнали",
    "обучение форекс", "брокер форекс", "регулиран брокер",
    "копиране на сделки", "управление на средства",
]
